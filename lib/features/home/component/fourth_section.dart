...
class FourthSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < items.length; i += 2) {
      rows.add(
        Row(
          ...
          children: [
            Expanded(
              child: _buildProductCard(items[i]["img"]!, items[i]["title"]!),
            ),
            const SizedBox(width: 12),
            if (i + 1 < items.length)
              Expanded(
                child: _buildProductCard(
                    items[i + 1]["img"]!, items[i + 1]["title"]!),
              ),
          ],
        ),
      );
    ...
    return Padding(
      padding: const EdgeInsets.all(16.0), // padding around section
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: rows,
      ),
  ...
  Widget _buildProductCard(String imgPath, String title) {
    return ClipRRect(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      // Small green square with white star
                      Container(
